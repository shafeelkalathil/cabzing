...
class CTextTheme{
  ...
  static TextTheme lightTextTheme=TextTheme(
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 10,fontWeight: FontWeight.normal,color: Colors.white),
    labelSmall: const TextStyle().copyWith(fontSize: 8,fontWeight: FontWeight.normal,color: Colors.white.withOpacity(0.5)),
